...
@RestController
@RequestMapping("/api/recon-kafka")
public class ReconKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReconKafkaResource.class);
    ...
    public ReconKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
